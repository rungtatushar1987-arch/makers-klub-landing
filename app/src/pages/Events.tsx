    ...
    <>
      ...
      <div className="mkw-main-body">
        <div className="ev-grid">
          ...
          {/* ── RIGHT: past events rail — matches Dashboard right rail ── */}
                ...
                <>
                  <div className="mkw-rows">
                    {past.map((event) => {
                      ...
                      return (
                        <div key={event.id}>
                          {/* Event row — identical to Dashboard EventRow compact */}
                          ...
                          {/* Toggle button — mk-btn-navy mk-btn-sm full width, same as Dashboard "Full calendar" */}
      ...
      <div style={{
        ...
        {event.description && (
          <div style={{ marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 14, color: 'var(--ink-2)', lineHeight: 1.7, fontFamily: 'var(--font-body)' }}>
              {event.description}
            </p>
          </div>
        )}
